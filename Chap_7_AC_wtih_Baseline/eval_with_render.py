...
parse.add_argument("--det_act", action="store_true")
parse.add_argument("--sto_act", action="store_true")
parse.add_argument("--sto_sta", action="store_true")
parse.add_argument("--path", type=str, default='./Results_dir/sto_sta/actor.pth')
# parse.add_argument("--path", type=str, default='./Results_dir/sto_sta_baseline/2022-05-16-13-05-42/actor_1940.pth')  # old
# parse.add_argument("--path", type=str, default='./Results_dir/sto_sta_baseline/2022-05-21-18-18-02/actor_1980.pth')  # new
